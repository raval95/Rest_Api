...
public class SimpleREST extends AbstractVerticle {
  ...
  public SimpleREST() {
    ...
    mongoAuth = getMongoAuth(vertx,client);
  }
  ...
  private void handleLogin(RoutingContext routingContext){
      ...
      String p = principal.getString("password");
       String l =principal.getString("login");
  ...
  private MongoAuth getMongoAuth(Vertx vertx, MongoClient client) {
